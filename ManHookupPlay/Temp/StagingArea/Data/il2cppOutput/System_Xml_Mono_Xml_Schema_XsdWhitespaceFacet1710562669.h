...
struct  XsdWhitespaceFacet_t1710562669 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XsdWhitespaceFacet_t1710562669, ___value___1)); }
