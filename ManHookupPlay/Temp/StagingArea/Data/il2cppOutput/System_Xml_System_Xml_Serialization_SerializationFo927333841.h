...
struct  SerializationFormat_t927333841 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SerializationFormat_t927333841, ___value___1)); }
