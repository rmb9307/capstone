...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'DevelopmentText.data';
    var REMOTE_PACKAGE_BASE = 'DevelopmentText.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 15560329;
      var PACKAGE_UUID = 'fae4b37b-e745-4778-9024-e5c539b825e9';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 11985082, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(11985082, 11985101, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(11985101, 11988652, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(11988652, 14657732, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(14657732, 15532704, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(15532704, 15560329, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_DevelopmentText.data');

    };
    Module['addRunDependency']('datafile_DevelopmentText.data');
